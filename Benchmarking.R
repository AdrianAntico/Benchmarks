...
data.table::fwrite(BenchmarkResults, "C:/Users/Bizon/Documents/GitHub/rappwd/BenchmarkResults.csv")
rm(BenchmarkResults)
...
## 1M 1N 1D 0G
data <- fread("C:/Users/Bizon/Documents/GitHub/rappwd/FakeBevData1M.csv")
BenchmarkResults <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/BenchmarkResults.csv")
start <- Sys.time()
...
## 10M 1N 1D 0G
data <- fread("C:/Users/Bizon/Documents/GitHub/rappwd/FakeBevData10M.csv")
BenchmarkResults <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/BenchmarkResults.csv")
start <- Sys.time()
...
## 100M 1N 1D 0G
data <- fread("C:/Users/Bizon/Documents/GitHub/rappwd/FakeBevData100M.csv")
BenchmarkResults <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/BenchmarkResults.csv")
start <- Sys.time()
data[, sum(`Daily Liters`), by = Date]
end <- Sys.time()
