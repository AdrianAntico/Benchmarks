...
data.table::fwrite(BenchmarkResults, "C:/Users/Bizon/Documents/GitHub/rappwd/BenchmarkResultsDuckDB.csv")
rm(BenchmarkResults)

# Environment setup
library(duckdb)
library(DBI)
data <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/FakeBevData1M.csv")
...
## 1M 1N 1D 0G
BenchmarkResults <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/BenchmarkResultsDuckDB.csv")
start <- Sys.time()
...
dbDisconnect(con)
data <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/FakeBevData10M.csv")
data.table::setnames(data, c("Beverage Flavor", "Daily Liters", "Daily Margin", "Daily Revenue", "Daily Units"), c("BeverageFlavor", "DailyLiters", "DailyMargin", "DailyRevenue", "DailyUnits"))
con = dbConnect(duckdb::duckdb())
ncores = parallel::detectCores()
invisible(dbExecute(con, sprintf("PRAGMA THREADS=%d", ncores)))
...
dbDisconnect(con)
data <- data.table::fread("C:/Users/Bizon/Documents/GitHub/rappwd/FakeBevData100M.csv")
data.table::setnames(data, c("Beverage Flavor", "Daily Liters", "Daily Margin", "Daily Revenue", "Daily Units"), c("BeverageFlavor", "DailyLiters", "DailyMargin", "DailyRevenue", "DailyUnits"))
con = dbConnect(duckdb::duckdb())
ncores = parallel::detectCores()
invisible(dbExecute(con, sprintf("PRAGMA THREADS=%d", ncores)))
