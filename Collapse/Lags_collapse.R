...
start <- Sys.time()
ftransformv(data, c("Daily Liters"), flag, 1:5, apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters"), flag, 1:5, list(Customer), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters"), flag, 1:5, list(Customer, Brand), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters"), flag, 1:5, list(Customer, Brand, Category), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters"), flag, 1:5, list(Customer, Brand, Category, `Beverage Flavor`), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units"), flag, 1:5, apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units"), flag, 1:5, list(Customer), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units"), flag, 1:5, list(Customer, Brand), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units"), flag, 1:5, list(Customer, Brand, Category), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units"), flag, 1:5, list(Customer, Brand, Category, `Beverage Flavor`), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units", "Daily Margin"), flag, 1:5, apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units", "Daily Margin"), flag, 1:5, list(Customer), apply = FALSE)
end <- Sys.time()
...
BenchmarkResults <- data.table::fread(paste0(Path, "BenchmarkResultsCollapse_Lags.csv"))
start <- Sys.time()
ftransformv(data, c("Daily Liters", "Daily Units", "Daily Margin"), flag, 1:5, list(Customer, Brand), apply = FALSE)
end <- Sys.time()
