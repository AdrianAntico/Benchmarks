...
for i in range(0,3):
  ...
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Daily Liters') > 20))
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Daily Liters') > 20))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Brand').is_in(BrandList)) & (pl.col('Daily Liters') > 20))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Brand').is_in(BrandList)) & (pl.col('Category').is_in(CatList)) & (pl.col('Daily Liters') > 20))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Brand').is_in(BrandList)) & (pl.col('Category').is_in(CatList)) & (pl.col('Beverage Flavor').is_in(BevFlavList)) & (pl.col('Daily Liters') > 20))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Daily Liters') > 20) & (pl.col('Daily Margin') < 100))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Daily Liters') > 20) & (pl.col('Daily Margin') < 100))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Brand').is_in(BrandList)) & (pl.col('Daily Liters') > 20) & (pl.col('Daily Margin') < 100))
  end = timeit.default_timer()
  rts[i] = end - start
...
for i in range(0,3):
  print(i)
  start = timeit.default_timer()
  x = data.filter((pl.col('Date') > d.date(2021,6,1)) & (pl.col('Customer').is_in(CustList)) & (pl.col('Brand').is_in(BrandList)) & (pl.col('Category').is_in(CatList)) & (pl.col('Daily Liters') > 20) & (pl.col('Daily Margin') < 100))
  end = timeit.default_timer()
  rts[i] = end - start
